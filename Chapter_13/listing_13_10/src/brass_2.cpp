...
// Description : демонстраци€ поведени€ виртуальных методов
//============================================================================
...
void Brass::Deposit(double amt)
{
	if(amt<0)
		...
		<<" deposite if canceled.\n	";// отрицательный вклад не допускаетс€
		else
			balance+=amt;
}
...
void Brass:: Withdraw(double amt)
{
	...
	if(amt<0)
		...
		<<" withdrawl canceled.\n"; //cнимаема€ сумма должна быть положительной
	else if (amt <= balance)
		balance-=amt;
	else
		cout<<"Withdrawl amount of $ "<<amt
		<<"exceeds your balance.\n"
		<<"Withdrawl canceled.\n"; //снимаема€ сумма превышает текущий баланс
